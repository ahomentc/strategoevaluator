...
{
	public:
		Game(const char * redPath, const char * bluePath, const char * red_setup, const char * blue_setup, const bool enableGraphics, double newStallTime = 1.0, const bool allowIllegal=false, FILE * newLog = NULL, const Piece::Colour & newRevealed = Piece::BOTH, int maxTurns = 5000, const bool printBoard = false, double newTimeoutTime = 2.0, const char * newImageOutput = "");
	...
	private:
		void MakeControllers(const char * redPath, const char * bluePath, const char * red_setup, const char * blue_setup); //Create a controller based off a path
	public:

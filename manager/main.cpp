...
Piece::Colour SetupGame(int argc, char ** argv)
{
	...
	if (inputFile == NULL)
	{
		...
		Game::theGame = new Game(red,blue, red_setup, blue_setup, graphics, stallTime, allowIllegal,log, reveal,maxTurns, printBoard, timeoutTime, imageOutput);
	}
	else
	{
